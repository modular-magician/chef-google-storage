...
context 'gstorage_object_access_control' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gstorage_object_access_control gstorage_bucket],
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gstorage_object_access_control 'title0' do
                    action :create
                  ...
                  gstorage_object_access_control 'title1' do
                    action :create
                  ...
                  gstorage_object_access_control 'title2' do
                    action :create
            ...
            context 'gstorage_object_access_control[title0]' do
              subject do
                chef_run.find_resource(:gstorage_object_access_control, 'title0')
              end
            ...
            context 'gstorage_object_access_control[title1]' do
              subject do
                chef_run.find_resource(:gstorage_object_access_control, 'title1')
              end
            ...
            context 'gstorage_object_access_control[title2]' do
              subject do
                chef_run.find_resource(:gstorage_object_access_control, 'title2')
              end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gstorage_object_access_control,
                                       'title0')
          end
          # TODO(alexstephen): Implement resourceref test.
          # it 'bucket' do
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gstorage_object_access_control,
                                       'title0')
          end
        end
  ...
  def expand_variables(template, data, extra_data = {})
    Google::GSTORAGE::ObjectAccessControl
