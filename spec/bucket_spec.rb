      ...
      context 'no changes == no action' do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            context 'gstorage_bucket[title0]', broken: true do
              pending('Implement tests where object references its own type')
            end

            context 'gstorage_bucket[title1]', broken: true do
              pending('Implement tests where object references its own type')
            end

            context 'gstorage_bucket[title2]', broken: true do
              pending('Implement tests where object references its own type')
            end
          end
    ...
    context 'resource missing' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          subject do
            chef_run.find_resource(:gstorage_bucket, 'title0')
          end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gstorage_bucket,
                                       'title0')
          end
        end
