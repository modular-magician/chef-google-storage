...
name 'google-gstorage'
maintainer 'Google'
maintainer_email 'nelsona@google.com'
license 'apachev2'
description 'A Chef cookbook to manage Google Cloud Storage resources'
long_description '
...
issues_url 'https://github.com/GoogleCloudPlatform/chef-google-storage/issues' \
  if respond_to?(:issues_url)
source_url 'https://github.com/GoogleCloudPlatform/chef-google-storage' \
