...
#       "recipe[gstorage::tests~bucket_access_control]"
#
...
gstorage_bucket 'chef-e2e-storage-module-test' do
  action :create
  project 'google.com:graphite-playground'
  credential 'mycred'
end

gstorage_bucket_access_control 'chef-e2e-user-nelsona@google.com' do
  action :create
  bucket 'chef-e2e-storage-module-test'
